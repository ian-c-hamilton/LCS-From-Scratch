...
Welcome to `lcs` contributor's guide.
...
If you experience bugs or general issues with `lcs`, please have a look
...
You can help improve `lcs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`lcs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `lcs`'s files. While this mechanism can
...
```
conda create -n lcs python=3 six virtualenv pytest pytest-cov
conda activate lcs
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/lcs.git
   cd lcs
   ```
...
5. Install [pre-commit]:
   ...
   `lcs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/lcs
[issue tracker]: https://github.com/<USERNAME>/lcs/issues
